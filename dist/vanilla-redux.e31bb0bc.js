...
// DOM 조작
var btnOn = document.querySelector('.toggle');
var counter = document.querySelector('h1');
var btnUp = document.querySelector('#up');
var btnDown = document.querySelector('#down');
var btnReset = document.querySelector('#reset');
var modal = document.querySelector('.container'); // 액션의 이름을 정의 -1

var ON_OFF = 'ON_OFF';
var UP = "UP";
var DOWN = 'DOWN';
var RESET = "RESET"; // 액션 함수 정의 -2
...
var upUp = function upUp(difference) {
  return {
    type: UP,
